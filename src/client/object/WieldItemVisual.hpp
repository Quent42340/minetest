...
*/
#ifndef WIELDITEMVISUAL_HPP_
#define WIELDITEMVISUAL_HPP_

#include "client/object/IGenericCAOVisual.hpp"
#include "client/wieldmesh.h"

class WieldItemVisual : public IGenericCAOVisual {
	public:
		...
		scene::ISceneNode *node() override { return m_wield_meshnode; }

	private:
		WieldMeshSceneNode *m_wield_meshnode = nullptr;
};

#endif // WIELDITEMVISUAL_HPP_
